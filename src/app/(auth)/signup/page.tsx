          ...
          <div className="flex items-center gap-3 mt-4">
            {[1, 2].map((s) => (
              <div key={s} className="flex items-center gap-3">
                ...
                <span className={`text-sm ${s <= step ? "text-white/80" : "text-white/30"}`}>
              ...
              <>
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="all_levels">All Levels (Nursery to SS3)</option>
                  </select>
                </div>
                <div>
                  <label className="block text-xs font-semibold text-gray-600 uppercase tracking-wide mb-1.5">
                  ...
                  >
                    {["Lagos","Abuja (FCT)","Rivers","Kano","Oyo","Anambra",
                      "Delta","Ogun","Enugu","Kaduna","Imo","Borno",
                      "Akwa Ibom","Edo","Plateau","Others"].map((s) => (
