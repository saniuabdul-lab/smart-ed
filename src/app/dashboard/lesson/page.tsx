      ...
      <div className="flex items-start gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-gray-500 text-sm">
            Create structured lesson plans using the ABCD Behavioural
            Objective Method.
          </p>
        </div>
      </div>
        ...
        <div className="space-y-5">
          ...
          <div className="bg-amber-50 border border-amber-100 rounded-xl p-4">
            ...
            <p className="text-xs text-gray-500 leading-relaxed">
              SMART Objectives, 5E Model, unlimited generations and DOCX
              export.
            </p>
          </div>
        </div>
          ...
          {loading ? (
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-6 space-y-5">
                ...
                <div className="border border-gray-100 rounded-xl overflow-hidden">
                  <div className="bg-gray-50 px-4 py-2.5 border-b border-gray-100">
                    <span className="text-xs font-bold text-gray-700 uppercase tracking-wide">
                      ABCD Learning Objective
                    </span>
                  </div>
                  <div className="p-4 space-y-3">
                    {Object.entries(result.objectives).map(
                      ([key, val]: [string, any]) => (
              ...
              {result.teacherActivities && (
                <div className="border border-gray-100 rounded-xl overflow-hidden">
                  ...
                  <div className="p-4 space-y-3">
                    {result.teacherActivities?.map(
                      (a: any, i: number) => (
                        <div key={i} className="flex gap-3">
                          <div className="w-5 h-5 bg-teal-50 border border-teal-100 rounded-full flex items-center justify-center flex-shrink-0 font-mono text-xs font-semibold text-teal-600">
                            {i + 1}
                          </div>
                          <div>
              ...
              {result.evaluation && (
                <div className="border border-gray-100 rounded-xl p-4">
                  ...
                  {result.evaluation.questions?.map(
                    (q: string, i: number) => (
                      <p
                        key={i}
                        className="text-xs text-gray-600 mb-2 flex gap-2"
                      >
              ...
              <div className="p-3 bg-amber-50 border border-amber-100 rounded-xl flex items-center gap-2">
                ...
                <p className="text-xs text-amber-700 font-medium">
                  Pro unlocks SMART Objectives, 5E Model and complete
                  scheme integration.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border-2 border-dashed border-gray-200 p-12 flex flex-col items-center justify-center text-center">
              ...
              <p className="text-gray-400 text-sm max-w-xs">
                Configure your options and click Generate to build your
                lesson plan.
              </p>
            </div>
          )}
