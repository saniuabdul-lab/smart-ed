    ...
    try {
      ...
      if (!res.ok) {
        if (data.error === "FREE_LIMIT_REACHED") {
          setError("You have reached your free limit. Upgrade to continue generating.");
        } else {
      ...
      <div className="flex items-start gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-gray-500 text-sm leading-relaxed">
            Generate a complete NERDC-aligned curriculum outline with topics,
            sub-topics, weekly breakdown, objectives and expected outcomes.
          </p>
        </div>
      </div>
          ...
          {loading ? (
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-6">
              ...
              <div className="mt-4 p-3 bg-amber-50 border border-amber-100 rounded-xl flex items-center gap-2">
                ...
                <p className="text-xs text-amber-700 font-medium">
                  Pro includes clean DOCX export, school letterhead,
                  full customization and Bloom&apos;s taxonomy alignment.
                </p>
              </div>
            </div>
          ) : (
            <div className="bg-white rounded-2xl border-2 border-dashed border-gray-200 p-12 flex flex-col items-center justify-center text-center">
              ...
              <p className="text-gray-400 text-sm leading-relaxed max-w-xs">
                ...
                &ldquo;Generate with AI&rdquo; to create your curriculum outline.
              </p>
            </div>
          )}
        </div>
