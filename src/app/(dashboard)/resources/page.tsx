          ...
          {loading ? (
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-6 space-y-4">
              ...
              {categories.map((cat) => (
                ...
                >
                  <div className={`px-4 py-2.5 border-b ${colorMap[cat.color]}`}>
                    <span className="text-xs font-bold uppercase tracking-wide">
                      {cat.title}
                    </span>
                  </div>
                  <div className="p-4 space-y-2">
                    {result[cat.key]?.map((item: string, i: number) => (
              ...
              <div className="p-3 bg-amber-50 border border-amber-100 rounded-xl flex items-center gap-2">
                ...
                <p className="text-xs text-amber-700 font-medium">
                  Pro includes advanced digital resources, video recommendations
                  and downloadable classroom kits.
                </p>
              </div>
            </div>
          ) : (
            <div className="bg-white rounded-2xl border-2 border-dashed border-gray-200 p-12 flex flex-col items-center justify-center text-center">
              ...
              <p className="text-gray-400 text-sm max-w-xs">
                Select your class and subject then click Generate to discover
                teaching resources.
              </p>
            </div>
          )}
